...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  // To accommodate NetSuite's dynamic token URL
  if (req.query.company) {
    this._oauth2._accessTokenUrl = `https://${req.query.company}.suitetalk.api.netsuite.com/services/rest/auth/oauth2/v1/token`;
  }
